...
-- NOTIFICATION TRIGGER FOR REALTIME ALERT PUBLISHING
...
-- 13. VEHICLE WATCHLIST / BLACKLIST
CREATE TABLE IF NOT EXISTS vehicle_watchlist (
    ...
    priority VARCHAR(32) DEFAULT 'HIGH', -- 'CRITICAL' | 'HIGH' | 'MEDIUM'
...
-- 15. DATA QUALITY LOGS
CREATE TABLE IF NOT EXISTS data_quality_logs (
    log_id SERIAL PRIMARY KEY,
    event_payload JSONB,
    failure_reason VARCHAR(255) NOT NULL,
    classification VARCHAR(32) NOT NULL, -- 'REJECTED' | 'WARNING' | 'QUARANTINED'
    camera_id VARCHAR(64),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);

-- 16. OPTIMIZATION & SEARCH INDEXES
